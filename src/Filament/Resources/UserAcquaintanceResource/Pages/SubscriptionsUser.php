...
class SubscriptionsUser extends InteractionsUser implements HasTable
{
    use InteractsWithTable, InteractsWithFormActions;
    use HasPageSidebar;

    public static string $relationQueryName = 'subscribe';
    public static string $relationName = 'subscriptions';
